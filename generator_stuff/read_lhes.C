...
void read_lhes(){
    ...
    t1->SetDirectory(0);
    string f1("/home/ozamram/Documents/Research/Generators/POWHEG-BOX-V2/Z_ew-BMNNPV/DY_M400_jun18/pwgevents.lhe");
    fill_tree(f1, t1, true);

    TFile *fout1 = TFile::Open("powheg_m400_evts.root", "RECREATE");
    fout1->cd();
    t1->Write();
    fout1->Close();
    delete t1;
