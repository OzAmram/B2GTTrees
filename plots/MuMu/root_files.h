...
void init(){
    ...
    f_data = TFile::Open("../analyze/output_files/SingleMuon_data_slim_july10.root");
    t_data = (TTree *)f_data->Get("T_data");
    //f_mc = TFile::Open("../analyze/output_files/MuMu_DY_mar19.root");
    f_mc = TFile::Open("../analyze/output_files/MuMu_DY_slim_july10.root");
    ...
    f_diboson = TFile::Open("../analyze/output_files/MuMu_diboson_july10.root");
    t_diboson = (TTree *)f_diboson->Get("T_data");

    f_wt = TFile::Open("../analyze/output_files/MuMu_WT_july10.root");
