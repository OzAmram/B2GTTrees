...
void init(){
    ...
    f_data = TFile::Open("../analyze/output_files/SingleMuon_data_slim_july5.root");
    t_data = (TTree *)f_data->Get("T_data");
    //f_mc = TFile::Open("../analyze/output_files/MuMu_DY_mar19.root");
    f_mc = TFile::Open("../analyze/output_files/MuMu_DY_slim_july05.root");
    ...
    f_ttbar = TFile::Open("../analyze/output_files/MuMu_TTbar_july5.root");
    ...
    f_diboson = TFile::Open("../analyze/output_files/MuMu_diboson_july5.root");
    t_diboson = (TTree *)f_diboson->Get("T_data");

    f_wt = TFile::Open("../analyze/output_files/MuMu_WT_july5.root");
