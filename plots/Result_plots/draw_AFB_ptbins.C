...
void draw_AFB_ptbins(){
    ...
    Double_t y_comb[6] = {0.633, 0.631, 0.563, 0.417, 0.397, 0.349};
    Double_t y_comb_errs[6] = {0.011, 0.019, 0.028, 0.033, 0.041, 0.046};

    Double_t y_mumu[6] = {0.618, 0.624, 0.527, 0.383, 0.454, 0.359};
    Double_t y_mumu_errs[6] = {0.015, 0.025, 0.036, 0.041, 0.058, 0.062};


    Double_t y_elel[6] = {0.650, 0.640, 0.615, 0.485, 0.334, 0.337};
    Double_t y_elel_errs[6] = {0.017, 0.029, 0.043, 0.058, 0.059, 0.068};
