...
void draw_AFB_mbins(){
    ...
    Double_t y_comb[6] = {0.611, 0.612, 0.614, 0.608, 0.559, 0.532};
    Double_t y_comb_errs[6] = {0.019, 0.023, 0.023, 0.029, 0.046, 0.063};

    Double_t y_mumu[6] = {0.590, 0.608, 0.634, 0.642, 0.584, 0.580};
    Double_t y_mumu_errs[6] = {0.022, 0.028, 0.028, 0.038, 0.063, 0.090};


    Double_t y_elel[6] = {0.640, 0.617, 0.589, 0.567, 0.535, 0.495};
    Double_t y_elel_errs[6] = {0.025, 0.032, 0.032, 0.042, 0.068, 0.084};
