...
void draw_AFB_mbins(){
    ...
    Double_t y_comb[6] = {0.610, 0.604, 0.610, 0.574, 0.562, 0.525};
    Double_t y_comb_errs[6] = {0.020, 0.022, 0.023, 0.028, 0.044, 0.062};

    Double_t y_mumu[6] = {0.592, 0.593, 0.614, 0.610, 0.573, 0.552};
    Double_t y_mumu_errs[6] = {0.020, 0.028, 0.028, 0.041, 0.065, 0.089};
