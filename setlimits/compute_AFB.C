...
TComplex Zp_Amplitude(Double_t s, Double_t M_Zp, int hand1, int hand2, int qtype){
...
Double_t Zp_AFB(Double_t E, Double_t M_Zp, int qtype){
    // E is energy to compute AFB, qtype = 0 = u,c,t, =1= d,s,b
    TComplex A_LL = Zp_Amplitude(E*E, M_Zp, 0,0,qtype); 
    TComplex A_LR = Zp_Amplitude(E*E, M_Zp, 0,1,qtype); 
    TComplex A_RL = Zp_Amplitude(E*E, M_Zp, 1,0,qtype); 
    TComplex A_RR = Zp_Amplitude(E*E, M_Zp, 1,1,qtype); 
...
Double_t Zp_xsec(Double_t E, Double_t c_s, Double_t M_Zp, int qtype){
    TComplex A_LL = Zp_Amplitude(E*E, M_Zp, 0,0,qtype); 
    TComplex A_LR = Zp_Amplitude(E*E, M_Zp, 0,1,qtype); 
    TComplex A_RL = Zp_Amplitude(E*E, M_Zp, 1,0,qtype); 
    TComplex A_RR = Zp_Amplitude(E*E, M_Zp, 1,1,qtype); 
