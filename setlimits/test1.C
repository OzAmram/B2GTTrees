...
void test1(){
    ...
    TF1 *AFB_u = new TF1("AFB_u", AFB_utype, 1.,1500.);
    TF1 *AFB_d = new TF1("AFB_d", AFB_dtype, 1.,1500.);

    TF1 *Zp_AFB_u = new TF1("Zp_AFB_u", Zp_AFB_utype, 1.,1500.);
    TF1 *Zp_AFB_d = new TF1("Zp_AFB_d", Zp_AFB_dtype, 1.,1500.);
    AFB_d->SetLineColor(kBlue);
    Zp_AFB_d->SetLineColor(kOrange);
    ...
    leg1->AddEntry(AFB_d, "SM d-type AFB", "l");
    leg1->AddEntry(Zp_AFB_u, "Z' (2 Tev) u-type AFB", "l");
    leg1->AddEntry(Zp_AFB_d, "Z' (2 Tev) d-type AFB", "l");
    leg1->Draw();
