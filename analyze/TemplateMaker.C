...
int gen_mc_template(TTree *t1, TH2F* h_sym, TH2F *h_asym, TH2F *h_count, Double_t m_low, Double_t m_high){
    Long64_t nEntries  =  t1->GetEntries();
    //printf("size is %i \n", nEntries);
...
int gen_background_template(TTree *t1, TH2F* h, TH2F* h_count, Double_t m_low, Double_t m_high){
    Long64_t nEntries  =  t1->GetEntries();
