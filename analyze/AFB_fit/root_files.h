...
void init(){
    ...
    f_elel_mc = (TFile*) TFile::Open("output_files/ElEl_DY_slim_nov2.root");
    ...
    f_elel_QCD = TFile::Open("../analyze/output_files/ElEl_QCD_est_nov26.root");
    t_elel_QCD = (TTree *)f_elel_QCD->Get("T_data");

    f_elel_WJets = TFile::Open("../analyze/output_files/ElEl_WJets_est_nov26.root");
    t_elel_WJets = (TTree *)f_elel_WJets->Get("T_data");

    f_elel_WJets_contam = TFile::Open("../analyze/output_files/ElEl_WJets_MC_contam_nov5.root");
    t_elel_WJets_contam = (TTree *)f_elel_WJets_contam->Get("T_data");

    f_elel_QCD_contam = TFile::Open("../analyze/output_files/ElEl_QCD_MC_contam_nov5.root");
    t_elel_QCD_contam = (TTree *)f_elel_QCD_contam->Get("T_data");
    ////////////////////////////////////////

    f_mumu_data = TFile::Open("output_files/SingleMuon_data_slim_nov26.root");
    t_mumu_data = (TTree *)f_mumu_data->Get("T_data"); 

    f_mumu_mc = (TFile*) TFile::Open("output_files/MuMu_DY_slim_nov2.root");
    ...
    f_mumu_QCD = TFile::Open("../analyze/output_files/MuMu_QCD_est_nov26.root");
    t_mumu_QCD = (TTree *)f_mumu_QCD->Get("T_data");

    f_mumu_WJets = TFile::Open("../analyze/output_files/MuMu_WJets_est_nov26.root");
    t_mumu_WJets = (TTree *)f_mumu_WJets->Get("T_data");

    f_mumu_WJets_contam = TFile::Open("../analyze/output_files/MuMu_WJets_MC_contam_nov5.root");
    t_mumu_WJets_contam = (TTree *)f_mumu_WJets_contam->Get("T_data");

    f_mumu_QCD_contam = TFile::Open("../analyze/output_files/MuMu_QCD_MC_contam_nov5.root");
...
//////////////////////////////////////////////
    ...
    f_mumu_ss_dy = TFile::Open("../analyze/output_files/MuMu_samesign_DY_jan16.root");
