...
const TString mumu_fout_name("AFB_fit/fit_results/m_bins/MuMu_fit_finite_mc_stat_fixed_july9.root");
const TString elel_fout_name("AFB_fit/fit_results/m_bins/ElEl_fit_finite_mc_stat_fixed_july9.root");
...
void finite_mc_fit_v2(){
    ...
    for(int i=0; i<6; i++){
        ...
        else setHistParams(minuit, h_mumu_sym, h_mumu_asym, 2);
