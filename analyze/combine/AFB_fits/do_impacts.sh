...
do
    ...
    pars="Pu,BTAG,alpha,elScale,elSmear,elHLT,elID,elRECO,muRC,muID,muHLT,muTRK,alphaS,alphaDen,RENORM,FAC,lumi,dy_xsec,bk_xsec,gam_xsec,ee_qcd,mu_qcd,emu_qcd,Rdy_ee_ss,R_ee_os_fakes"
