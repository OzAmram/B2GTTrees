...
#do
    ...
    #combine -M GenerateOnly -d $workspace --toysFrequentist -t $nToys --expectSignal 0.6 --saveToys --freezeParameters $freezeParam
    ...
    combine -M FitDiagnostics -d $workspace --toysFile higgsCombineTest.GenerateOnly.mH120.123456.root  -t $nToys -S 0
